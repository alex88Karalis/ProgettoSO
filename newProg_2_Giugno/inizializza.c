...
void inizializzaSprites(Sprite* sprites){
	...
	// per ottenere il puntatore di puntatore devo castare ad esempio sprite_rana ad un puntatore di puntatore: (char **)sprite_rana

	sprites[S_RANA] = inizializzaSprite(RANA_H, RANA_W,sprite_rana, RANA_COL);
  	sprites[S_PROIETTILE] = inizializzaSprite(PROIETTILE_H, PROIETTILE_W, sprite_proiettile, PROIETTILE_COL);
	sprites[S_TANA_APERTA] = inizializzaSprite(TANA_H, TANA_W, sprite_tana_open, TANE_COL);
	sprites[S_TANA_CHIUSA] = inizializzaSprite(TANA_H, TANA_W, sprite_tana_closed, TANE_COL);
	//sprites[S_PIANTA] = inizializzaSprite(PIANTA_H,PIANTA_W,sprite_pianta,PIANTA_COL);
	//sprites[S_PROIETTILE_NEMICO] = inizializzaSprite(PROIETTILE_H,PROIETTILE_W,sprite_proiettile_nemico,PROIETTILE_COL);
	//sprites[S_COCCODRILLO_SX] = inizializzaSprite(COCCODRILLO_H,COCCODRILLO_W,sprite_coccodrillo_sx,COCCODRILLOBUONO_COL);
	//sprites[S_COCCODRILLO_DX] = inizializzaSprite(COCCODRILLO_H,COCCODRILLO_W,sprite_coccodrillo_dx,COCCODRILLOBUONO_COL);
	return;
}
