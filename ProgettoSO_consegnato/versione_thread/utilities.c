...
/** @brief Imposta tutti i thread a target per farli terminare.Resetta conteggio tempo e HUD del tempo
 * @param p (Param*) Struttura con gameData e semafori. Necessaria  per avere i semafori per impostare i thread a "target"
 */
...
/** @brief Se Rana termina le vite o chiude tutte le tane, termina il gioco 
